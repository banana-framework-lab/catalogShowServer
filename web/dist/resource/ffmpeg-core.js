var createFFmpegCore = (function () {
    ...
    return (
        function (createFFmpegCore) {
            ...
            else if (ma || oa) oa ? ra = self.location.href : "undefined" !== typeof document && document.currentScript && (ra = document.currentScript.src), _scriptDir && (ra = _scriptDir), 0 !== ra.indexOf("blob:") ? ra = ra.substr(0, ra.lastIndexOf("/") + 1) : ra = "", l ? (ta = function (a,
                b) {
                wa || (wa = require("fs"));
                xa || (xa = require("path"));
                a = xa.normalize(a);
            ...
            f.dynCall = function (a, b, c) {
                var d; - 1 != a.indexOf("j") ? d = c && c.length ? f["dynCall_" + a].apply(null, [b].concat(c)) : f["dynCall_" + a].call(null, b) : d = G.get(b).apply(null, c);
                return d
            };
            var rb = 0,
                sb = 0,
                    ...
                    cf: {
                        ...
                        rename: function (a, b, c) {
                            if (N.kf(a.mode)) {
                                ...
                                if (d)
                                    for (var e in d.bf) throw new N.af(55);
                            }
                ...
                N = {
                    ...
                    zj: function (a) {
                        ...
                        Object.keys(N.Cf).forEach(function (d) {
                            for (d = N.Cf[d]; d;) {
                                var e = d.Pf; - 1 !== c.indexOf(d.jf) && N.Ng(d);
                                d = e
                            }
                        });
                        a.lg = null;
            ...
            var Ge = {
                ...
                uc: function (a, b, c) {
                    if (c)
                        if (a >= $c) T(1281);
                            ...
                            var d = hd[a];
                            if (d)
                                if (35716 == b) a = U.getProgramInfoLog(R[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a.length + 1;
                                else if (35719 ==
                                b) D[c >> 2] = d.Xg;
                            else if (35722 == b) {
                                if (-1 == d.jg) {
                                ...
                                if (-1 == d.kg)
                                    for (a = R[a], e = U.getProgramParameter(a, 35382), b = d.kg = 0; b < e; ++b) d.kg = Math.max(d.kg, U.getActiveUniformBlockName(a, b).length + 1);
                                D[c >> 2] = d.kg
                ...
                wb: function (a,
                    b, c) {
                    if (144 >= b)
                        for (var d = zd[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = F[c + 4 * e >> 2], d[e + 1] = F[c + (4 * e + 4) >> 2];
                ...
                ub: function (a, b, c) {
                    if (144 >= b)
                        for (var d = Ad[2 * b - 1], e = 0; e < 2 * b; e += 2) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2];
                ...
                sb: function (a, b, c) {
                    if (96 >= b)
                        for (var d = zd[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = F[c + 4 * e >> 2], d[e + 1] = F[c + (4 * e + 4) >> 2], d[e + 2] =
                            F[c + (4 * e + 8) >> 2];
                ...
                qb: function (a, b, c) {
                    if (96 >= b)
                        for (var d = Ad[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2], d[e + 2] = D[c + (4 * e + 8) >> 2];
                ...
                mb: function (a, b, c) {
                    if (72 >= b)
                        for (var d = Ad[4 * b - 1], e = 0; e < 4 * b; e += 4) d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2], d[e + 2] = D[c + (4 * e + 8) >> 2], d[e + 3] = D[c + (4 * e + 12) >> 2];
                    else d = D.subarray(c >> 2, c + 16 * b >> 2);
                    U.uniform4iv(S[a], d)
                },
                lb: function (a, b, c, d) {
                    if (72 >= b)
                        for (var e = zd[4 * b - 1], g = 0; g < 4 * b; g += 4) e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2];
                ...
                kb: function (a, b, c, d) {
                    if (32 >= b)
                        for (var e = zd[9 * b - 1], g = 0; g < 9 * b; g += 9) e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2], e[g + 4] = F[d + (4 * g + 16) >> 2], e[g + 5] = F[d + (4 * g + 20) >> 2], e[g + 6] = F[d + (4 * g + 24) >> 2], e[g + 7] = F[d + (4 * g + 28) >> 2], e[g + 8] = F[d + (4 * g + 32) >> 2];
                ...
                n: function (a,
                    ...
                    if (b) {
                        ...
                        if (0 === D[b + 16 >> 2]) {
                            ...
                            if (m || r)
                                if (B)
                                    if (D[B + 12 >> 2] !== B) h("pthread_getschedparam attempted on thread " +
            ...
            (function () {
                ...
                if (f.instantiateWasm) try {
                    ...
                    return Ba || "function" !== typeof WebAssembly.instantiateStreaming || kb() || ib("file://") ||
                        "function" !== typeof fetch ? c(b) : fetch(jb, {
                            credentials: "same-origin"
                        }).then(function (e) {
            ...
            function Me(a) {
                function b() {
                    if (!Ke && (Ke = !0, f.calledRun = !0, !Ea)) {
                        ...
                        if (!n) {
                            if (f.postRun)
                                for ("function" == typeof f.postRun && (f.postRun = [f.postRun]); f.postRun.length;) c = f.postRun.shift(), ab.unshift(c);
                            pb(ab)
                        }
                    }
                }
